...
router.get("/getqueries",verifyToken.verifyToken,verifyToken.isAdmin, FooterQueryController.getQueries)
router.get("/getqueries/:id",verifyToken.verifyToken,verifyToken.isAdmin, FooterQueryController.getQueryById)
router.get("/query-read/:id",verifyToken.verifyToken, verifyToken.isAdmin, FooterQueryController.markRead)
router.delete("/deletequery/:id",verifyToken.verifyToken, verifyToken.isAdmin, FooterQueryController.deleteQuery)
